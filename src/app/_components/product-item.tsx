...
const ProductItem = (product: Product) => {
  return (
    <Link href={`/${product.slug}`} className="w-fit">
      <Card className="p-0">
        <CardContent className="relative flex h-[270px] w-[200px] flex-col justify-between px-3 py-2">
          ...
          <div className="flex items-center justify-center gap-3 rounded-md bg-neutral-900 text-center text-neutral-100 transition-all duration-700 ease-linear hover:bg-emerald-500">
            <BsCart4 />
            Comprar
          </div>
        </CardContent>
